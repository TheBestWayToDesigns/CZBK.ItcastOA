...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class PU_PurchaseOrder_b
    {
        ...
        public Nullable<decimal> countInQuantity2 { get; set; }
        ...
        public Nullable<decimal> countArrivalQuantity { get; set; }
        public Nullable<decimal> countArrivalQuantity2 { get; set; }
        public Nullable<decimal> countInQuantity { get; set; }
        public Nullable<decimal> countQuantity { get; set; }
        public Nullable<decimal> countQuantity2 { get; set; }
        ...
        public Nullable<int> arrivalTimes { get; set; }
        public Nullable<int> stockTimes { get; set; }
        ...
        public Nullable<int> idPurchaseOrderDTO { get; set; }

...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class ME_IntegralForGift_b
    {
        public string code { get; set; }
        public string name { get; set; }
        public string inventorybarcode { get; set; }
        public Nullable<decimal> quantity { get; set; }
        public Nullable<decimal> needintegral { get; set; }
        public Nullable<decimal> needtotalintegral { get; set; }
        ...
        public Nullable<int> idIntegralForGiftDTO { get; set; }

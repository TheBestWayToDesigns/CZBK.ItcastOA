...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class DI_StockSalesReport_b
    {
        public string code { get; set; }
        public string name { get; set; }
        public Nullable<decimal> quantity { get; set; }
        public Nullable<decimal> dailyaveragesalesquantity { get; set; }
        public Nullable<decimal> stockquantity { get; set; }
        public Nullable<decimal> ReplenishQuantity { get; set; }
        public Nullable<decimal> ReplenishQuantityByStockUnit { get; set; }
        public Nullable<byte> ispersist { get; set; }
        public Nullable<decimal> quantitybystockunit { get; set; }
        public Nullable<decimal> dailyaveragesalesquantitybystockunit { get; set; }
        public Nullable<decimal> stockquantitybystockunit { get; set; }
        ...
        public Nullable<int> idInventoryMutiCode { get; set; }
        public Nullable<int> idunit { get; set; }
        public Nullable<int> idunit2 { get; set; }
        public Nullable<int> idStockSalesReportDTO { get; set; }

...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class GL_Userdefinedtransformdetail
    {
        public string summary { get; set; }
        public string accountcode { get; set; }
        public string formula { get; set; }
        public string amountformula { get; set; }
        public string origformula { get; set; }
        public Nullable<decimal> rate { get; set; }
        public byte[] ts { get; set; }
        public string exAuxAccCollection { get; set; }
        public Nullable<int> FormulaAuxAccType { get; set; }
        public string AuxXMLHideValue { get; set; }
        ...
        public Nullable<int> idUserDefinedTransformDTO { get; set; }
        public Nullable<System.DateTime> createdtime { get; set; }
        public byte IsFormulaDirectValue { get; set; }
    }
}

...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class ARAP_OriginalAmount_ArDetail
    {
        ...
        public Nullable<decimal> OrigInitialRevenue { get; set; }
        public Nullable<decimal> InitialRevenue { get; set; }
        public Nullable<decimal> OrigActualInitialRevenue { get; set; }
        public Nullable<decimal> ActualInitialRevenue { get; set; }
        public Nullable<decimal> OrigActualOtherArAmount { get; set; }
        public Nullable<decimal> ActualOtherArAmount { get; set; }
    }
}

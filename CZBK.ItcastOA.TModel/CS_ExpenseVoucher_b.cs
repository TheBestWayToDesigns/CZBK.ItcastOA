...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class CS_ExpenseVoucher_b
    {
        ...
        public Nullable<byte> isApportion { get; set; }
        ...
        public string expenseItemUse { get; set; }
        public int ID { get; set; }
        public Nullable<int> idexpenseitem { get; set; }
        public Nullable<int> idproject { get; set; }
        public Nullable<int> idExpenseVoucherDTO { get; set; }
        public Nullable<int> saleOrderDetailId { get; set; }
        public Nullable<int> idexpenseallocationvouchertype { get; set; }
    }
}

...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class ST_CheckVoucher_b
    {
        ...
        public Nullable<decimal> amountInStock { get; set; }
        public Nullable<decimal> amount { get; set; }
        public Nullable<decimal> balanceAmount { get; set; }
        public Nullable<decimal> quantityInStock2 { get; set; }
        public Nullable<decimal> quantity2 { get; set; }
        public Nullable<decimal> balanceQuantity2 { get; set; }
        public Nullable<decimal> changeRate { get; set; }
        public string batch { get; set; }
        public string receiveVoucherCode { get; set; }
        public Nullable<decimal> baseQuantityInStock { get; set; }
        public Nullable<decimal> baseQuantity { get; set; }
        public Nullable<decimal> baseBalanceQuantity { get; set; }
        public Nullable<decimal> subQuantityInStock { get; set; }
        public Nullable<decimal> subQuantity { get; set; }
        public Nullable<decimal> subBalanceQuantity { get; set; }
        ...
        public string compositionQuantityInStock { get; set; }
        ...
        public Nullable<int> idCheckVoucherDTO { get; set; }

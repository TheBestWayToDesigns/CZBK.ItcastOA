...
namespace CZBK.ItcastOA.TModel
{
    ...
    public partial class ME_MemberStorage
    {
        public string code { get; set; }
        public string name { get; set; }
        public string cardcode { get; set; }
        public Nullable<decimal> memberquantity { get; set; }
        public Nullable<decimal> storageamount { get; set; }
        public Nullable<decimal> singlestorageamount { get; set; }
        ...
        public Nullable<int> idintegralmember { get; set; }
